...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__css_my_style_css__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__css_my_style_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__css_my_style_css__);
...
const uriServe = "http://localhost:3000/";
...
let NegociacaoService = class NegociacaoService {
    ...
    obtemNegociacoesDaSemana() {
        ...
        return this._http.get(uriServe + 'negociacoes/semana').then(dados => dados.map(objeto => new __WEBPACK_IMPORTED_MODULE_1__Negociacao_js__["a" /* Negociacao */](new Date(objeto.data), objeto.quantidade, objeto.valor)), err => {
    ...
    obtemNegociacoesDaSemanaAnterior() {
        ...
        return this._http.get(uriServe + 'negociacoes/anterior').then(dados => dados.map(objeto => new __WEBPACK_IMPORTED_MODULE_1__Negociacao_js__["a" /* Negociacao */](new Date(objeto.data), objeto.quantidade, objeto.valor)), err => {
    ...
    obtemNegociacoesDaSemanaRetrasada() {
        ...
        return this._http.get(uriServe + 'negociacoes/retrasada').then(dados => dados.map(objeto => new __WEBPACK_IMPORTED_MODULE_1__Negociacao_js__["a" /* Negociacao */](new Date(objeto.data), objeto.quantidade, objeto.valor)), err => {
